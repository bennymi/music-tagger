...
if __name__ == '__main__':
    # gl = GeniusLyrics(single_url='https://genius.com/Ed-sheeran-afterglow-lyrics', folder_path=r'C:\Users\BennySoul\Documents\Coding\My Projects\album-downloader\images')
    
    single_urls = [
        'https://genius.com/Bts-serendipity-full-length-edition-lyrics',
        'https://genius.com/Bts-magic-shop-lyrics',
        'https://genius.com/Bts-im-fine-lyrics',
        'https://genius.com/Ed-sheeran-afterglow-lyrics'
    ]
    
    album_urls = [
        'https://genius.com/albums/Bts/Love-yourself-tear',
        'https://genius.com/albums/Bts/Love-yourself-her',
        'https://genius.com/albums/Ed-sheeran/Divide'
    ]
    
    # for url in album_urls:
    #     gl = GeniusLyrics(album_url=url)
    #     gl.get_album_artist()
    #     gl.get_album_title()
    #     gl.get_album_release_date()
    #     # gl.get_album_tracks()
        
    #     for song in gl.album.songs:
    #         song.log_info()
    
    for url in single_urls:
        # gl = GeniusLyrics(artist="BTS", single_url=url, folder_path=r'C:\Users\BennySoul\Documents\Coding\My Projects\album-downloader\images')
        gl = GeniusLyrics(single_url=url)
        gl.get_all_single_info(url)
        gl.album.songs[0].log_info()
        # gl.get_single_album()
        # gl.get_single_title()
        # gl.get_single_track_number()
        # gl.get_single_album()
        # gl.get_single_release_date()
        # gl.get_single_artist()
        # print('\n')
    #     break